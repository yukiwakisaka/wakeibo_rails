...
class ExchangesControllerTest < ActionController::TestCase
  ...
  test "should create exchange" do
    assert_difference('Exchange.count') do
      post :create, exchange: { amount: @exchange.amount, exchange_date: @exchange.exchange_date, minus_item_id: @exchange.minus_item_id, plus_item_id: @exchange.plus_item_id, user_id: @exchange.user_id }
    end
  ...
  test "should update exchange" do
    patch :update, id: @exchange, exchange: { amount: @exchange.amount, exchange_date: @exchange.exchange_date, minus_item_id: @exchange.minus_item_id, plus_item_id: @exchange.plus_item_id, user_id: @exchange.user_id }
    assert_redirected_to exchange_path(assigns(:exchange))
  end
